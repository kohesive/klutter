...
class TestUriBuilder {
    ...
    @Test fun testOtherThingsThereOrAbsent() {
    ...
    @Test fun testDifferentQuerySetters() {
        val original = "http://www.klutter.uy"
    ...
    @Test fun testSpaceSpecialInQuery() {
