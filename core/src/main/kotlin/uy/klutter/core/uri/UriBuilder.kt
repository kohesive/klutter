...
fun buildUri(uri: URI): UriBuilder {
...
fun buildUri(uriString: String): UriBuilder {
    return buildUri(URI(uriString))
}

fun buildUri(url: URL): UriBuilder {
    return buildUri(url.toURI())
}

fun buildUri(uri: ImmutableUri): UriBuilder {
