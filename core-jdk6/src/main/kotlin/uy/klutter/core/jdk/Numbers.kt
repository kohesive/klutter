...
public fun Int.coerce(range: IntRange): Int = this.minimum(range.start).maximum(range.endInclusive)
...
public fun Long.coerce(range: LongRange): Long = this.minimum(range.start).maximum(range.endInclusive)
...
public fun Byte.coerce(range: IntRange): Byte = this.minimum(range.start.toByte()).maximum(range.endInclusive.toByte())
...
public fun Short.coerce(range: IntRange): Short = this.minimum(range.start.toShort()).maximum(range.endInclusive.toShort())
